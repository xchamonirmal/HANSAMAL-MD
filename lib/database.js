...
ANTI_BOT: [],
ALIVE: `default`,
FOOTER: 'ʜᴀɴꜱᴀᴍᴀʟ-ᴍᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ\nᴄʀᴇᴀᴛᴇᴅ ʙʏ • ʜᴀɴꜱᴀᴍᴀʟ',
LOGO: `https://i.postimg.cc/yx0bdqMg/IMG-20241217-WA0053.jpg` 
}
...
ANTI_BAD: [],
MAX_SIZE: 100,
WORK_TYPE: "default", // Added WORK_TYPE
STATUS_VIEW: true,
AUTO_TYPING: false,
ALWAYS_ONLINE: false,
AUTO_RECORDING: false,
...
config.FOOTER = 'ʜᴀɴꜱᴀᴍᴀʟ-ᴍᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ\nᴄʀᴇᴀᴛᴇᴅ ʙʏ • ʜᴀɴꜱᴀᴍᴀʟ'
config.LOGO = `https://i.postimg.cc/yx0bdqMg/IMG-20241217-WA0053.jpg` 
config.ANTI_BAD = [];
config.WORK_TYPE = [];
config.STATUS_VIEW = [];
config.AUTO_TYPING = [];
